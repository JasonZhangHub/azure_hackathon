...
def app():
    ...
    def main():
        ...
        if side_menu_selectbox == 'Home':
            home(homepage_path='../../Downloads/Git_trial/azure_hackathon/lidas/docs/homepage.md',
                 contact_path='../../Downloads/Git_trial/azure_hackathon/lidas/docs/contact_us.md')
        elif side_menu_selectbox == 'Forecast':
            forecast_ui(forecast_ui_path='../../Downloads/Git_trial/azure_hackathon/lidas/docs/forecast_ui.md')
        elif side_menu_selectbox == 'Geoservice':
            geoservice_ui(geoservice_ui_path='../../Downloads/Git_trial/azure_hackathon/lidas/docs/geoservice_ui.md')
        elif side_menu_selectbox == 'News Feed':
            newsfeed_ui(newsfeed_ui_path='../../Downloads/Git_trial/azure_hackathon/lidas/docs/newsfeed_ui.md')
        elif side_menu_selectbox == 'Community':
            community_ui(community_ui_path='../../Downloads/Git_trial/azure_hackathon/lidas/docs/community_ui.md')

    if __name__ == '__main__':
        st.set_page_config(page_title='LIDAS', page_icon='./docs/lidaslogo.png', layout='centered',
